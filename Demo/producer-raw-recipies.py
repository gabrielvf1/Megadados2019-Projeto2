# References code : [Getting started with Apache Kafka in Python](http://blog.adnansiddiqi.me/getting-started-with-apache-kafka-in-python/)
...
def get_recipes():
    ...
    print('Fazendo Crawler na internet')
    kafka_producer = connect_kafka_producer()
    print('Iniciando stream de producer - raw-recipes')
